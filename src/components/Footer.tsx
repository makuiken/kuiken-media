      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center space-x-8 mb-8">
          ...
          <motion.a
            whileHover={{ scale: 1.1, y: -2 }}
            whileTap={{ scale: 0.95 }}
            href="https://www.linkedin.com/in/caleb-kuiken/"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <motion.a
            whileHover={{ scale: 1.1, y: -2 }}
            whileTap={{ scale: 0.95 }}
            href="https://www.youtube.com/@kuikenmedia"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm">
            © {currentYear} Kuiken Media. All rights reserved.
          </p>
        </div>
        ...
        <div className="text-center text-xs">
          <motion.a
            ...
            href="https://montague-design.com"
            target="_blank"
            rel="noopener noreferrer"
